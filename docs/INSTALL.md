...
|---------------------------------|------------------------------------------------------------------------------|:----:|:------:|:-----:|:-------:|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Arch Linux<br><br>Manjaro Linux | [onedrive-abraunegg](https://aur.archlinux.org/packages/onedrive-abraunegg/) |<img src="./images/tick.gif" alt="supported" width="26" height="26"/>|<img src="./images/tick.gif" alt="supported" width="26" height="26"/>|<img src="./images/tick.gif" alt="supported" width="26" height="26"/>|<img src="./images/tick.gif" alt="supported" width="26" height="26"/>| Install via: `pamac build onedrive-abraunegg`<br><br>**Note:** If asked regarding a provider for 'd-runtime' and 'd-compiler', select 'liblphobos' and 'ldc'<br><br>**Note:** System must have at least 1GB of memory & 1GB swap space
| Debian                          | [onedrive](https://packages.debian.org/sid/net/onedrive)                     |![supported](./images/tick.gif) width="31" height="21"|![supported](./images/tick.gif) width="31" height="21"|![supported](./images/tick.gif) width="31" height="21"|![supported](./images/tick.gif) width="31" height="21"|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Fedora                          | [onedrive](https://koji.fedoraproject.org/koji/packageinfo?packageID=26044)  |![supported](./images/tick.gif) width="31" height="21"|![supported](./images/tick.gif) width="31" height="21"|![supported](./images/tick.gif) width="31" height="21"|![supported](./images/tick.gif) width="31" height="21"|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Gentoo                          | [onedrive](https://gpo.zugaina.org/net-misc/onedrive)                        |![supported](./images/tick.gif)|![supported](./images/tick.gif)|       |         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| NixOS                           | onedrive                                                                     |      |![supported](./images/tick.gif)|       |         | Use package `onedrive` either by adding it to `configuration.nix` or by using the command `nix-env -iA <channel name>.onedrive`. This does not install a service. To install a service, use unstable channel (will stabilize in 20.09) and add `services.onedrive.enable=true` in `configuration.nix`. You can also add a custom package using the `services.onedrive.package` option (recommended since package lags upstream). Enabling the service installs a default package too (based on the channel). You can also add multiple onedrive accounts trivially, see [documentation](https://github.com/NixOS/nixpkgs/pull/77734#issuecomment-575874225). |
| openSUSE                        | [onedrive](https://software.opensuse.org/package/onedrive)                   |![supported](./images/tick.gif)|![supported](./images/tick.gif)|       |         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Slackware                       | [onedrive](https://slackbuilds.org/repository/14.2/network/onedrive/)        |![supported](./images/tick.gif)|![supported](./images/tick.gif)|       |         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Solus                           | [onedrive](https://dev.getsol.us/search/query/FB7PIf1jG9Z9/#R)               |![supported](./images/tick.gif)|![supported](./images/tick.gif)|       |         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Ubuntu                          | [onedrive](https://launchpad.net/~yann1ck/+archive/ubuntu/onedrive)          |      |![supported](./images/tick.gif)|       |         | Install via the Ubuntu PPA Archive:<br><br>```sudo add-apt-repository ppa:yann1ck/onedrive<br>sudo apt-get update<br>sudo apt install onedrive```|
