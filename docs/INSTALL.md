...
|---------------------------------|------------------------------------------------------------------------------|:----:|:------:|:-----:|:-------:|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Arch Linux<br><br>Manjaro Linux | [onedrive-abraunegg](https://aur.archlinux.org/packages/onedrive-abraunegg/) |![supported](./images/tick.gif)|![supported](./images/tick.gif)|![supported](./images/tick.gif)|![supported](./images/tick.gif)| Install via: `pamac build onedrive-abraunegg`<br><br>**Note:** If asked regarding a provider for 'd-runtime' and 'd-compiler', select 'liblphobos' and 'ldc'
| Debian                          | [onedrive](https://packages.debian.org/sid/net/onedrive)                     |![supported](./images/tick.gif)|![supported](./images/tick.gif)|![supported](./images/tick.gif)|![supported](./images/tick.gif)|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Fedora                          | [onedrive](https://koji.fedoraproject.org/koji/packageinfo?packageID=26044)  |![supported](./images/tick.gif)|![supported](./images/tick.gif)|![supported](./images/tick.gif)|![supported](./images/tick.gif)|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
