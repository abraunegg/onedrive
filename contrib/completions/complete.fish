...
complete -c onedrive -l display-admin-consent-url -d "Display a tenant-specific Microsoft Entra ID administrator consent URL"
...
complete -c onedrive -s h -l help -d "Show help message"
...
complete -c onedrive -l mirror-local-state -d "Mirror the local state to Microsoft OneDrive online"
complete -c onedrive -l modified-by -d "Show who last modified a file"
complete -c onedrive -s m -l monitor -d "Run in monitor mode"
...
complete -c onedrive -s s -l sync -d "Start sync operation"
...
complete -c onedrive -s v -l verbose -d "Increase verbosity"
