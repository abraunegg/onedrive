...
all_opts=(
  ...
  '--display-admin-consent-url[Display a tenant-specific Microsoft Entra ID administrator consent URL]'
  ...
  '--mirror-local-state[Mirror the local state to Microsoft OneDrive online]'
  '--modified-by[Display the last modified-by details]:file or directory:'
  '-m[Keep monitoring for local and remote changes]'
  ...
  '-s[Perform a synchronisation with Microsoft OneDrive]'
  ...
  '-v[Print more details, useful for debugging (repeat for extra debugging)]'
