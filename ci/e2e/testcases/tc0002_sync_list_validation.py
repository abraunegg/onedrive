...
class TestCase0002SyncListValidation(E2ETestCase):
    ...
    def _build_scenarios(self) -> list[SyncListScenario]:
        return [
            ...
            SyncListScenario(
                scenario_id="SL-0027",
                description="wildcard directory include across similarly named Project Code folders",
                sync_list=[f"/{FIXTURE_ROOT_NAME}/Projects/Code*"],
                allowed_prefixes=[
                    f"{FIXTURE_ROOT_NAME}/Projects/Code",
                    f"{FIXTURE_ROOT_NAME}/Projects/Code-Archive",
                ...
                required_processed=[
                    f"{FIXTURE_ROOT_NAME}/Projects/Code/JOBXYZ/Exports/file.wav",
                    f"{FIXTURE_ROOT_NAME}/Projects/Code/JOBXYZ/Source/main.txt",
                    f"{FIXTURE_ROOT_NAME}/Projects/Code-Archive/archive.txt",
                    f"{FIXTURE_ROOT_NAME}/Projects/Codecs/readme.txt",
                    f"{FIXTURE_ROOT_NAME}/Projects/Coder/profile.txt",
                ],
                required_skipped=[
                    f"{FIXTURE_ROOT_NAME}/Projects/Audio",
                    f"{FIXTURE_ROOT_NAME}/Projects/Video",
            ...
            SyncListScenario(
                scenario_id="SL-0028",
                description="globbing directory include for src directories across nested project depths",
                sync_list=[f"/{FIXTURE_ROOT_NAME}/Programming/Projects/**/src/"],
                allowed_prefixes=[
                    f"{FIXTURE_ROOT_NAME}/Programming/Projects/Android/App1/src",
                    f"{FIXTURE_ROOT_NAME}/Programming/Projects/Android/App2/src",
                    f"{FIXTURE_ROOT_NAME}/Programming/Projects/Web/Site1/src",
            ...
            SyncListScenario(
                scenario_id="SL-0029",
                description="wildcard directory include with deeper wildcard exclusion",
                sync_list=[
                    f"!/{FIXTURE_ROOT_NAME}/Projects/Code*/JOBXYZ/Exports/*",
                    f"/{FIXTURE_ROOT_NAME}/Projects/Code*",
                ],
                ...
                forbidden_prefixes=[f"{FIXTURE_ROOT_NAME}/Projects/Code/JOBXYZ/Exports"],
                required_processed=[
                    f"{FIXTURE_ROOT_NAME}/Projects/Code/JOBXYZ/Source/main.txt",
                    f"{FIXTURE_ROOT_NAME}/Projects/Code-Archive/archive.txt",
                    f"{FIXTURE_ROOT_NAME}/Projects/Codecs/readme.txt",
            ...
            SyncListScenario(
                scenario_id="SL-0030",
                description="globbing directory include with recursive globbing exclusion",
                sync_list=[
                    f"!/{FIXTURE_ROOT_NAME}/Programming/Projects/**/build/*",
                    f"/{FIXTURE_ROOT_NAME}/Programming/Projects/**/src/",
                ],
                allowed_prefixes=[
                    f"{FIXTURE_ROOT_NAME}/Programming/Projects/Android/App1/src",
                    f"{FIXTURE_ROOT_NAME}/Programming/Projects/Android/App2/src",
            ...
            SyncListScenario(
                scenario_id="SL-0031",
                description="normal directory include with deeper wildcard exclusion must not exclude ancestor",
                sync_list=[
                    f"!/{FIXTURE_ROOT_NAME}/Documents/Notes/.config/*",
                    f"/{FIXTURE_ROOT_NAME}/Documents/Notes/",
                ],
                allowed_prefixes=[f"{FIXTURE_ROOT_NAME}/Documents/Notes"],
                forbidden_prefixes=[f"{FIXTURE_ROOT_NAME}/Documents/Notes/.config"],
                required_processed=[f"{FIXTURE_ROOT_NAME}/Documents/Notes/keep.txt"],
                required_skipped=[
                    f"{FIXTURE_ROOT_NAME}/Documents/Notes/.config",
                    f"{FIXTURE_ROOT_NAME}/Documents/latest_report.docx",
                ],
            ...
            SyncListScenario(
                scenario_id="SL-0032",
                description="normal directory include with deeper globbing exclusion must not exclude ancestor",
                sync_list=[
                    f"!/{FIXTURE_ROOT_NAME}/Programming/Projects/**/.cxx/*",
                    f"/{FIXTURE_ROOT_NAME}/Programming/Projects/Android/",
                ],
                allowed_prefixes=[f"{FIXTURE_ROOT_NAME}/Programming/Projects/Android"],
                forbidden_prefixes=[
                    f"{FIXTURE_ROOT_NAME}/Programming/Projects/Android/App1/.cxx",
                    f"{FIXTURE_ROOT_NAME}/Programming/Projects/Android/App2/.cxx",
                ],
