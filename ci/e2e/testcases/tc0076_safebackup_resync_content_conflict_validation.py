...
class TestCase0076SafeBackupResyncContentConflictValidation(SafeBackupCaseBase):
    ...
    def run(self, context: E2EContext) -> TestResult:
        ...
        details.update(
            {
                ...
                "local_xlsx_pre_resync_hash": local_xlsx_hash,
        ...
        verify_xlsx_error = validate_xlsx(verify_xlsx, REVISION_0) if verify_xlsx.is_file() else "Verification canonical XLSX is missing"
