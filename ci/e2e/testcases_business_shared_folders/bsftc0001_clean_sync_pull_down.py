...
class BusinessSharedFolderTestCase0001CleanSyncPullDown(E2ETestCase):
    case_id = "bsftc0001"
    name = "business shared folders clean sync pull down"
    description = "Validate that --sync --verbose pulls down the preserved Business Account shared-folder topology"
