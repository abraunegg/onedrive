...
EXPECTED_TYPED_MANIFEST = [
    ...
    "SHARED_FOLDERS_RENAMED/RENAMED_FOLDER_15/",
    "SHARED_FOLDERS_RENAMED/RENAMED_FOLDER_15/original.txt",
    "SHARED_FOLDERS_RENAMED/RENAMED_FOLDER_15/upload-target/",
]
...
REQUIRED_STDOUT_MARKERS = [
    ...
    "Syncing this OneDrive Personal Shared Folder: ./SHARED_FOLDERS_RENAMED/RENAMED_FOLDER_15",
